...
internal class PqlGrammar(IQueryBuilder queryBuilder)
{
    ...
    [Production("relation : Parent[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : Parent[d] LeftParenthesis[d] Underscore Coma[d] Reference RightParenthesis[d]")]
    [Production("relation : Parent[d] LeftParenthesis[d] Underscore Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : ParentTransitive[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : ParentTransitive[d] LeftParenthesis[d] Underscore Coma[d] Reference RightParenthesis[d]")]
    [Production("relation : ParentTransitive[d] LeftParenthesis[d] Underscore Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : Modifies[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : Modifies[d] LeftParenthesis[d] QuoteReference Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : Follows[d] LeftParenthesis[d] Underscore Coma[d] Reference RightParenthesis[d]")]
    [Production("relation : Follows[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : Follows[d] LeftParenthesis[d] Underscore Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : FollowsTransitive[d] LeftParenthesis[d] Underscore Coma[d] Reference RightParenthesis[d]")]
    [Production("relation : FollowsTransitive[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : FollowsTransitive[d] LeftParenthesis[d] Underscore Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : Uses[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : Uses[d] LeftParenthesis[d] QuoteReference Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : Calls[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : Calls[d] LeftParenthesis[d] QuoteReference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : Calls[d] LeftParenthesis[d] Underscore Coma[d] Reference RightParenthesis[d]")]
    [Production("relation : Calls[d] LeftParenthesis[d] Underscore Coma[d] QuoteReference RightParenthesis[d]")]
    [Production("relation : Calls[d] LeftParenthesis[d] Underscore Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : Next[d] LeftParenthesis[d] Underscore Coma[d] Reference RightParenthesis[d]")]
    [Production("relation : Next[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : Next[d] LeftParenthesis[d] Underscore Coma[d] Underscore RightParenthesis[d]")]
    ...
    [Production("relation : NextTransitive[d] LeftParenthesis[d] Underscore Coma[d] Reference RightParenthesis[d]")]
    [Production("relation : NextTransitive[d] LeftParenthesis[d] Reference Coma[d] Underscore RightParenthesis[d]")]
    [Production("relation : NextTransitive[d] LeftParenthesis[d] Underscore Coma[d] Underscore RightParenthesis[d]")]
